...
public class SungJukAppUI extends JFrame implements ActionListener {
	...
	JButton						jbtn_addData	= new JButton("데이터 추가");
	...
	public void initDisplay() {
		...
		jp1.add("East", jp2);
		jbtn_addData.setEnabled(false);
		jp3.add(jbtn_addData);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == jtf_inwon || e.getSource() == jbtn_create) {
			...
			int[][] imsi = new int[dtm.getRowCount()][dtm.getColumnCount()];// 총점과 석차가 들어갈 공간
		...
		else if (e.getSource() == jbtn_addData) {
			String[][]	data	= { { "홍길동", "80", "75", "85" }, { "이성계", "90", "85", "80" },
													{ "강감찬", "70", "75", "70" } };
			int			a		= 0;
			int			b		= 0;
